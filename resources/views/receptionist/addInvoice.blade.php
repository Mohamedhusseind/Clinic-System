            ...
            <li class="nav-item active">
                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href={{route('add_invoice')}}>Add Invoice</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item ">
                ...
                <div id="collapsePages" class="collapse " aria-labelledby="headingPages" data-parent="#accordionSidebar" >
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item " href={{route('show_invoices')}}>Show Invoices</a>
                    </div>
                </div>
            </li>
                    ...
                    <div class="col-lg-9 " >
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">Add New Invoice</h1>
                            </div>
                            <div class="text-center">
                                <p class="h4  mb-4 text-success">{{Session::get('msg')}}</p>
                                <p class="h4  mb-4 text-danger">{{Session::get('error')}}</p>
                            </div>
                            <form  method="post" action="{{route('store_invoice')}}" class="user">
                                @csrf
                                <div class="form-group row col-sm-12">
                                    <input type="text" class="form-control form-control-user" id="patient_id" name="patient_id"
                                ...
                                <div class="form-group row">
                                    ...
                                    <input type="hidden" value="{{Session::get('receptionist_id')}}" name="receptionist_id" id="receptionist_id">
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                ...
                                <button type="submit" class="btn btn-primary btn-user btn-block">Add Invoice</button>
