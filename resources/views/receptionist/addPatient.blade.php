            ...
            <li class="nav-item active">
                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href={{route('add_patient')}}>Add Patient</a>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-9 " >
                        <div class="p-5">
                            ...
                            <form  method="post" action="{{route('store_patient')}}" class="user">
                                @csrf
                                ...
                                <button type="submit" class="btn btn-primary btn-user btn-block">Add Patient</button>
