            ...
            <li class="nav-item active">
                ...
                <div id="collapsePages" class="collapse show" aria-labelledby="headingPages" data-parent="#accordionSidebar" >
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href={{route('add_doctor')}}>Add Doctor</a>
                    </div>
                </div>
            </li>
                    ...
                    <div class="col-lg-9 " >
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">Add New Doctor!</h1>
                            </div>
                            <div class="text-center">
                                <p class="h4  mb-4 text-success">{{Session::get('msg')}}</p>
                                <p class="h4  mb-4 text-danger">{{Session::get('error')}}</p>
                            </div>
                            <form  method="post" action="{{route('store_doctor')}}" class="user">
                                @csrf
                                ...
                                <button type="submit" class="btn btn-primary btn-user btn-block">Add Doctor</button>
